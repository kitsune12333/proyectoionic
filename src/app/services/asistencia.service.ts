...
export class AsistenciaService {
  ...
  postAsistencia(asistenciaModel: AsistenciaModel): Observable<any>{
    return this._httpclient.post<any>(this.URL_SUPABASE,asistenciaModel,{ headers: this.supabaseheaders});
  }
